...
type User struct {
	...
	User                             *dovewing.PlatformUser `db:"-" json:"user" ci:"internal"` // Must be handled internally
...
type UserBot struct {
	...
	User         *dovewing.PlatformUser `db:"-" json:"user"`
...
type UserPerm struct {
	ID                    string                 `db:"user_id" json:"-"`
	User                  *dovewing.PlatformUser `db:"-" json:"user"` // Must be handled internally
